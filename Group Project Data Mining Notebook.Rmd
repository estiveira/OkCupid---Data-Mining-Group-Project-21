...
```{r - Imputation of missing values with mean per column}

okcupid_mean = okcupid

means = c(mean(as.numeric(okcupid$age), na.rm = TRUE), mean(as.numeric(okcupid$body_type), na.rm = TRUE), mean(as.numeric(okcupid$diet), na.rm = TRUE), mean(as.numeric(okcupid$drinks), na.rm = TRUE), mean(as.numeric(okcupid$drugs), na.rm = TRUE), mean(as.numeric(okcupid$education), na.rm = TRUE), mean(as.numeric(okcupid$ethnicity), na.rm = TRUE), mean(as.numeric(okcupid$height), na.rm = TRUE), mean(as.numeric(okcupid$income), na.rm = TRUE), mean(as.numeric(okcupid$job), na.rm = TRUE), mean(as.numeric(okcupid$offspring), na.rm = TRUE), mean(as.numeric(okcupid$orientation), na.rm = TRUE), mean(as.numeric(okcupid$pets), na.rm = TRUE), mean(as.numeric(okcupid$religion), na.rm = TRUE), mean(as.numeric(okcupid$sex), na.rm = TRUE), mean(as.numeric(okcupid$sign), na.rm = TRUE), mean(as.numeric(okcupid$smokes), na.rm = TRUE), mean(as.numeric(okcupid$status), na.rm = TRUE))

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$age[i]))) {
    okcupid_mean$age[i] = round(means[1])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$body_type[i]))) {
    okcupid_mean$body_type[i] = round(means[2])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$diet[i]))) {
    okcupid_mean$diet[i] = round(means[3])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$drinks[i]))) {
    okcupid_mean$drinks[i] = round(means[4])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$drugs[i]))) {
    okcupid_mean$drugs[i] = round(means[5])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$education[i]))) {
    okcupid_mean$education[i] = round(means[6])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$ethnicity[i]))) {
    okcupid_mean$ethnicity[i] = round(means[7])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$height[i]))) {
    okcupid_mean$height[i] = round(means[8])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$income[i]))) {
    okcupid_mean$income[i] = round(means[9])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$job[i]))) {
    okcupid_mean$job[i] = round(means[10])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$offspring[i]))) {
    okcupid_mean$offspring[i] = round(means[11])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$orientation[i]))) {
    okcupid_mean$orientation[i] = round(means[12])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$pets[i]))) {
    okcupid_mean$pets[i] = round(means[13])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$religion[i]))) {
    okcupid_mean$religion[i] = round(means[14])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$sex[i]))) {
    okcupid_mean$sex[i] = round(means[15])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$sign[i]))) {
    okcupid_mean$sign[i] = round(means[16])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$smokes[i]))) {
    okcupid_mean$smokes[i] = round(means[17])
  }
}

for (i in 1:nrow(okcupid_mean)) {
  if (is.na(as.numeric(okcupid_mean$status[i]))) {
    okcupid_mean$status[i] = round(means[18])
  }
}

okcupid_mean = okcupid_mean %>% dplyr::select(- income, - sign, - religion, - offspring)

okcupid_mean

```

```{r - Imputation of missing values with mice}
...
```{r - Creating Social engagement index for the imputation with mice}
...
```{r - Creating Social engagement index for the imputation with mean}

# Diet
for (i in 1:nrow(okcupid_mean)) {
  if (okcupid_mean$diet[i] == 1) {
    okcupid_mean$social_engagement[i] = 2
  }
  else if (okcupid_mean$diet[i] == 2) {
    okcupid_mean$social_engagement[i] = 3
  }
  else if (okcupid_mean$diet[i] == 3) {
    okcupid_mean$social_engagement[i] = 5
  }
...
for (i in 1:nrow(okcupid_mean)) {
  if (okcupid_mean$drinks[i] == 1) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 1
  }
  else if (okcupid_mean$drinks[i] == 2) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$drinks[i] == 3) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
  else if (okcupid_mean$drinks[i] == 4) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  else if (okcupid_mean$drinks[i] == 5) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
}
...
for (i in 1:nrow(okcupid_mean)) {
  if (okcupid_mean$drugs[i] == 1) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 2
  }
  else if (okcupid_mean$drugs[i] == 2){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  else if (okcupid_mean$drugs[i] == 3) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
}
...
for (i in 1:nrow(okcupid_mean)) {
  ...
  if (okcupid_mean$education[i] == 1) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
  else if (okcupid_mean$education[i] == 2){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$education[i] == 3) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 2
  }
  else if (okcupid_mean$education[i] == 4) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
}
...
for (i in 1:nrow(okcupid_mean)) {
  if (okcupid_mean$ethnicity[i] == 1) {
    okcupid_mean$social_engagement [i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$ethnicity[i] == 2){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  } 
  else if (okcupid_mean$ethnicity[i] == 3){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$ethnicity[i] == 4){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  else if (okcupid_mean$ethnicity[i] == 5) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
  else if (okcupid_mean$ethnicity[i] == 6) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$ethnicity[i] == 7) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 1
  }
  else if (okcupid_mean$ethnicity[i] == 8) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 2
  }
  else if (okcupid_mean$ethnicity[i] == 9){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
}
...
for (i in 1:nrow(okcupid_mean)) {
  ...
  if (okcupid_mean$job[i] == 1) {
    okcupid_mean$social_engagement [i] = okcupid_mean$social_engagement[i] + 4
  }
  
  else if (okcupid_mean$job[i] == 2) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
  
  else if (okcupid_mean$job[i] == 3) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement [i] + 5
  }
  
  else if (okcupid_mean$job[i] == 4) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement [i] + 4
  }
  else if (okcupid_mean$job [i] == 5) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  
  else if (okcupid_mean$job[i] == 6) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  
  else if (okcupid_mean$job [i] == 7) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
  
  else if (okcupid_mean$job [i] == 8){
    okcupid_mean$social_engagement [i] = okcupid_mean$social_engagement[i] + 3
  }
  
  else if (okcupid_mean$job[i] == 9) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  
  else if (okcupid_mean$job[i] == 10) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  
  else if (okcupid_mean$job[i] == 11) {
    okcupid_mean$social_engagement [i]= okcupid_mean$social_engagement [i] + 5
  }
  
  else if (okcupid_mean$job[i] == 12){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 2
  }
  
  else if (okcupid_mean$job[i] == 13) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
  else if (okcupid_mean$job[i] == 14) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$job[i] == 15) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 1
  }
  else if (okcupid_mean$job[i] == 16) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 2
  }
  else if (okcupid_mean$job[i] == 17) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 1
  }
  else if (okcupid_mean$job[i] == 18){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
}
...
for (i in 1:nrow(okcupid_mean)) {
  if (okcupid_mean$age[i] <= 24) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  else if (okcupid_mean$age[i] <= 34) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$age[i] <=44) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
  else if (okcupid_mean$age[i] <= 54) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
  else if (okcupid_mean$age[i] <= 64) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 2
  }
  else if (okcupid_mean$age[i] <= 74) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 1
  }
  else if (okcupid_mean$age[i] <= 84) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 1
  }
  else {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 1
...
for (i in 1:nrow(okcupid_mean)) {
  if (okcupid_mean$orientation[i] == 1) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
  else if (okcupid_mean$orientation[i] == 2) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  else if (okcupid_mean$orientation[i] == 3){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
}
...
for (i in 1:nrow(okcupid_mean)) {
  if (okcupid_mean$pets[i] == 1) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$pets[i] == 2){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  else if (okcupid_mean$pets[i] == 3){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$pets[i] == 4){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$pets[i] == 5){
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  else if (okcupid_mean$pets[i] == 6) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$pets[i] == 7) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 2
  }
  else if (okcupid_mean$pets[i] == 8) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
}
...
# Smokes
for (i in 1:nrow(okcupid_mean)) {
  if (okcupid_mean$smokes[i] == 1) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$smokes[i] == 2) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 3
  }
  else if (okcupid_mean$smokes[i] == 3) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 4
  }
  else if (okcupid_mean$smokes[i] == 4) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 5
  }
  else if (okcupid_mean$smokes[i] == 5) {
    okcupid_mean$social_engagement[i] = okcupid_mean$social_engagement[i] + 2
  }
}

okcupid_mean$social_engagement = round(okcupid_mean$social_engagement/11)
okcupid_mean$social_engagement

# Bar plot of the social engagement column
ggplot(okcupid_mean, aes(x = social_engagement)) +
  geom_bar(fill = corDegrade(4)) +
  labs(title = "Social Engagement Distribution", x = "Social Engagement", y = "Count")
...
# for the imputation with mean
set.seed(2003)
train.index_mean = sample(c(1:dim(okcupid_mean)[1]), dim(okcupid_mean)[1]*0.6)  
training_data_mean = okcupid_mean[train.index, ]
validation_data_mean = okcupid_mean[-train.index, ]

train_norm_mean = training_data_mean
valid_norm_mean = validation_data_mean
okcupid.norm_mean = okcupid_mean

norm_values_mean = preProcess(training_data_mean[, 1:14], method=c("center", "scale")); norm_values_mean
train_norm_mean[, 1:14] = predict(norm_values_mean, training_data_mean[, 1:14]); train_norm_mean
valid_norm_mean[, 1:14] = predict(norm_values_mean, validation_data_mean[, 1:14]); valid_norm_mean
okcupid.norm_mean[, 1:14] = predict(norm_values_mean, okcupid_mean[, 1:14]); okcupid.norm_mean
...
```{r - k-NN Model imputation with mice}
...
```{r - k-NN Model imputation with mean}

okcupid.norm_mean$body_type = as.numeric(okcupid.norm_mean$body_type)
okcupid.norm_mean$diet = as.numeric(okcupid.norm_mean$diet)
okcupid.norm_mean$drinks = as.numeric(okcupid.norm_mean$drinks)
okcupid.norm_mean$drugs = as.numeric(okcupid.norm_mean$drugs)
okcupid.norm_mean$education = as.numeric(okcupid.norm_mean$education)
okcupid.norm_mean$ethnicity = as.numeric(okcupid.norm_mean$ethnicity)
okcupid.norm_mean$job = as.numeric(okcupid.norm_mean$job)
okcupid.norm_mean$orientation = as.numeric(okcupid.norm_mean$orientation)
okcupid.norm_mean$pets = as.numeric(okcupid.norm_mean$pets)
okcupid.norm_mean$sex = as.numeric(okcupid.norm_mean$sex)
okcupid.norm_mean$smokes = as.numeric(okcupid.norm_mean$smokes)
okcupid.norm_mean$status = as.numeric(okcupid.norm_mean$status)

k_values_mean = c(1, 2, 3, 4, 5)
rmse_values_mean = data.frame(k = numeric(), rmse = numeric())

library(Metrics)

for (i in seq_along(k_values_mean)) {
  k = k_values_mean[i]
  prediction_mean = as.data.frame(class::knn(train = train_norm_mean[, c(1, 3:7, 9:13)], test = valid_norm_mean[, c(1, 3:7, 9:13)], cl = train_norm_mean[, 15], k = k))
  error_mean = valid_norm_mean[, 15] - as.numeric(as.character(prediction_mean[, 1]))
  error_squared_mean = error_mean^2
  rmse_mean = sqrt(mean(error_squared_mean))
  rmse_values_mean = rbind(rmse_values_mean, data.frame(k = k, rmse = rmse_mean))
}

rmse_values_mean

plot(rmse_values_mean$k, rmse_values_mean$rmse, type = "o", col = "magenta", xlab = "k", ylab = "RMSE", main = "RMSE vs k")

knn_mean = class::knn(train = train_norm_mean[, c(1, 3:7, 9:13)], test = valid_norm_mean[, c(1, 3:7, 9:13)], cl = train_norm_mean[, 15], k = 3)

```

```{r - Model Evaluation for the data set imputed with mice}
# Model evaluation for the validation set 

predictions = as.data.frame(class::knn(train = train_norm[, c(1, 3:7, 9:13)], test = valid_norm[, c(1, 3:7, 9:13)], cl = train_norm[, 15], k = 3))
confusion_matrix = table(as.numeric(as.character(predictions[, 1])), valid_norm[, 15])
confusion_matrix
...
mean(precision)
recall = diag(confusion_matrix) / colSums(confusion_matrix)
weighted_recall = sum((colSums(confusion_matrix) / sum(colSums(confusion_matrix))) * recall)
weighted_recall

```

```{r - Model Evaluation for the data set imputated with mean}
# Model evaluation for the validation set 

predictions_mean = as.data.frame(class::knn(train = train_norm_mean[, c(1, 3:7, 9:13)], test = valid_norm_mean[, c(1, 3:7, 9:13)], cl = train_norm_mean[, 15], k = 3))
confusion_matrix_mean = table(as.numeric(as.character(predictions_mean[, 1])), valid_norm_mean[, 15])
confusion_matrix_mean

# Calculating Accuracy 

accuracy_mean = sum(diag(confusion_matrix_mean)) / sum(confusion_matrix_mean)
accuracy_mean

# Precision and Recall 

precision_mean = diag(confusion_matrix_mean) / rowSums(confusion_matrix_mean)
mean(precision_mean)
recall_mean = diag(confusion_matrix_mean) / colSums(confusion_matrix_mean)
mean(recall_mean)
...
# Using the model created with the data imputed with mean, because the values for accuracy, precision and recall for the validation set are higher
...
kNN_pred_Nora = class::knn(train = okcupid.norm_mean[, c(1, 3:4, 6:7, 9:13)], test = Nora_norm, cl = okcupid.norm_mean[, 15], k = 3); kNN_pred_Nora
...
kNN_pred_Greg = class::knn(train = okcupid.norm_mean[, c(1, 3:4, 6:7, 9:13)], test = Greg_norm, cl = okcupid.norm_mean[, 15], k = 3); kNN_pred_Greg
...
kNN_pred_Augusta = class::knn(train = okcupid.norm_mean[, c(1, 3:4, 6:7, 9:13)], test = Augusta_norm, cl = okcupid.norm_mean[, 15], k = 3); kNN_pred_Augusta
